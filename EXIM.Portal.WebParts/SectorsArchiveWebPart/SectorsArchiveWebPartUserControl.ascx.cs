...
{
    public partial class SectorsArchiveWebPartUserControl : UserControl
    {
        public SectorsArchiveWebPart WebPartRef { get; set; }
     ...
     "/PublishingImages/DefaultImages/SectorsDefaultImg.png";
        ...
        private SPList ResolveTargetList(SPWeb web)
        {
            ...
            return LandingPageHelper.TryGetList(web, "Sectors")
