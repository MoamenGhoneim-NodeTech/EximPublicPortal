...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocumentsArchiveWebPartUserControl.ascx.cs" Inherits="EXIM.Portal.WebParts.DocumentsArchiveWebPart.DocumentsArchiveWebPartUserControl" %>



<%-- Items grid --%>
<div class="row study-items-item g-4">
    <asp:Repeater ID="rptDocumentItems" runat="server">
        <ItemTemplate>
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                <div class="study-item gap-4">
                    ...
                    <div class="study-action gap-3">
                        <a href='<%# Eval("FileRef") %>' download class="btn btn-secondary">
                            <%# Eval("DownloadText") %>
                        </a>
                    </div>
