...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FinancialServicesWebPartUserControl.ascx.cs" Inherits="EXIM.Portal.WebParts.FinancialServicesWebPart.FinancialServicesWebPartUserControl" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 exim-filters-sidebar">
            ...
            <div class="filter-actions mt-3">
                <asp:Button ID="btnApply" runat="server" Text="Apply" BorderStyle="None"
                    CssClass="exim-btn-link fw-bold"
                    CausesValidation="false" OnClick="btnApply_Click" />
                <span class="mx-2">|</span>
                <asp:Button ID="btnClear" runat="server" Text="Clear"  BorderStyle="None"
                    CssClass="exim-btn-link fw-bold" 
