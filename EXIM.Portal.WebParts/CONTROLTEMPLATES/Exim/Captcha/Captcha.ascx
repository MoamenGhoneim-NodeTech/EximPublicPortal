...
<div class="d-flex align-items-center gap-3">
    <img src="/_layouts/15/Exim.Portal/Captcha.aspx?w=200&h=50&f=20" alt="الرجاء إدخال النص الظاهر في الصورة" class="captchaimg">
    <asp:TextBox runat="server" ID="txtCaptcha" CssClass="form-control" EnableViewState="false" placeholder="Please enter the text shown in the image" autocomplete="off" meta:resourcekey="TextBox1Resource1"></asp:TextBox>
</div>
