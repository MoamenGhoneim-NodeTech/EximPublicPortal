    ...
    <div class="row g-4">
        ...
        <div class="col-md-6" data-aos="fade-up" data-aos-delay="120">
            <div class="form-group">
                ...
                <asp:TextBox runat="server" ID="txtCommNumber" TextMode="SingleLine" CssClass="form-control digits" meta:resourcekey="txtCommNumber" MaxLength="20" />
                ...
                <asp:RegularExpressionValidator runat="server" ID="revtxtCommNumber" ControlToValidate="txtCommNumber" ValidationExpression="^\d+$" meta:resourcekey="InvalidCommNumber" ValidationGroup="subscribe" CssClass="text-danger" Display="Dynamic" />
            </div>
        </div>
        ...
        <div class="col-md-6" data-aos="fade-up" data-aos-delay="140">
            <div class="form-group">
                ...
                <asp:TextBox runat="server" ID="txtResponsiblePersonName" TextMode="SingleLine" CssClass="form-control letters" meta:resourcekey="txtResponsiblePersonName" MaxLength="255" />
                ...
                <asp:RegularExpressionValidator runat="server" ID="revtxtResponsiblePersonName" ControlToValidate="txtResponsiblePersonName" ValidationExpression="^[\u0600-\u06FFa-zA-Z\s'\-]+$" meta:resourcekey="InvalidResponsiblePersonName" ValidationGroup="subscribe" CssClass="text-danger" Display="Dynamic" />
            </div>
        </div>
