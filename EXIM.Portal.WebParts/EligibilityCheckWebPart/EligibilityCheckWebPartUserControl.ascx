...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EligibilityCheckWebPartUserControl.ascx.cs" Inherits="EXIM.Portal.WebParts.EligibilityCheckWebPart.EligibilityCheckWebPartUserControl" %>

<%-- Items grid --%>
<div class="row study-items-item g-4">
    <asp:Repeater ID="rptPreAppItems" runat="server">
        <ItemTemplate>
