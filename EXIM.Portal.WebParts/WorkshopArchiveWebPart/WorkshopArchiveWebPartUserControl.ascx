...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkshopArchiveWebPartUserControl.ascx.cs" Inherits="EXIM.Portal.WebParts.WorkshopArchiveWebPart.WorkshopArchiveWebPartUserControl" %>
<%-- Items grid --%>
