...
{
    public partial class YearlyReportsWebPartUserControl : UserControl
    {
        public YearlyReportsWebPart WebPartRef { get; set; }
        ...
        private SPList ResolveTargetList(SPWeb web)
        {
            ...
            return LandingPageHelper.TryGetList(web, "Documents")
